...
En efecto, tenemos un porcentaje de error dentro de la muestra de 0.0388%, lo que confirma que la clasificación es bastante buena.
...
En este caso vemos que $E_{out}$ ha aumentado pero el porcentaje de error sigue siendo bajo, 0.5%, por lo que la clasificación sigue siendo muy buena.
