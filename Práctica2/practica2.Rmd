...
Le pasamos la función f y su grafiente al método de gradiente descendente y pintamos por dónde va pasando en las iteraciones, que es algo que nos devuelve el método:
...
Entonces el cociente $e_1/E_{cv}$ será mayor o menor según aumentemos $\lambda$ mucho o poco. 
...
Como vemos los valores medios han aumentado un poco, mientras que antes los valores mínimos estaban en 0.26 o un poco por debajo ahora se quedan un poco por encima, con lo que hemos aumentado $\lambda$ mucho, de forma que estamos ajustando un poco peor la función objetivo.  
