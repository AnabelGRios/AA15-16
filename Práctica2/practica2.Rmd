...
cat("El error de entropía cruzada es: ", errores)
```
...
DECIRLE EL PROBLEMA CON LOS DATOS DE TEST
...
La cota basada en $E_test$ es la cota de Hoeffding considerando $M=1$ pues cuando llegamos al test ya tenemos escogida la $h$, que es la recta elegida con los datos de entrenamiento.
...
FALTA ENUNCIADO DE EJERCICIO POR AQUÍ